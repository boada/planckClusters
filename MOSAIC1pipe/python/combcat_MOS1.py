...
class combcat:
    ...
    def swarp_BPM(self,conf="SWarp-common.conf",dryrun=None,combtype="SUM",filters=None):
	...
	detection_variables = tableio.get_data(detCatalog,detectionColumns)
        ...
        for filter in self.filters:
            ...
            nondetected = Numeric.less_equal(flux[filter],0.0)*Numeric.greater(fluxerr[filter],0.0)
