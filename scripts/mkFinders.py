...
# load the data
data = np.genfromtxt('PSZ2_unconfirmed_catalog_4NOAO_2016A_newSwift - PSZ2_unconfirmed_catalog_4NOAO_.csv', delimiter=',', names=True, dtype=None)
...
for i, _ in enumerate(data['RA']):
    ...
    d.set('regions', 'compass(2560,2350,30) #compass=fk5 {N} {E} 1 1 color=black')
