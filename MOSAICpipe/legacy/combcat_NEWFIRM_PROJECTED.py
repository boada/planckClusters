...
class combcat:
    ...
    def swarp_files(self,
        ...
        # Keys to keep
        keywords = ['OBJECT', 'TIMESYS', 'DATE-OBS', 'TIME-OBS', 'OBSTYPE',
                    'OBSERVAT', 'TELESCOP', 'HA', 'ZD', 'DETECTOR', 'DARKTIME',
                    'RA', 'DEC', 'MJD-OBS', 'INSTRUME', 'FILTER', 'AIRMASS',
                    'EXPTIME']
    ...
    def header_FSCALE(self, filters=None, dm=0.05):
        ...
        for filter in filters:
            ...
            # !!!! put_FSCALE is not a defined function !!!!
            for file in self.files[filter]:
